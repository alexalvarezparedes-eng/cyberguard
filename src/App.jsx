      ...
      <div style={wrap}>
        ...
        <div style={cont}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: 16, marginBottom: 12 }}>
            <button style={btn("dim")} onClick={() => { clearInterval(timerRef.current); setTimerActive(false); setQuizScenarios([]); setCurrentIdx(0); setSelected(null); setShowResult(false); setScore(0); setTotalPoints(0); setStreak(0); setBestStreak(0); setAnswers([]); setTimeLeft(40); setActiveBlock(null); setScreen("home"); }}>← Salir</button>
